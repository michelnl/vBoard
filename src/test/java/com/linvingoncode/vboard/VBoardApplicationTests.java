package com.linvingoncode.vboard;
...
import com.livingoncode.vboard.VBoardApplication;
...
public class VBoardApplicationTests {
	...
	public void findByNameTest() {
		...
		Board board3 = new Board(3L, "rifelsap", "testpass3", "Sample board text3");
		Board board4 = new Board(4L, "govtboys", "testpass4", "Sample board text4");
		Board board5 = new Board(5L, "shaheens", "testpass5", "Sample board text5");
